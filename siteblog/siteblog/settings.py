...
from django.conf.global_settings import STATIC_ROOT, STATICFILES_DIRS, INTERNAL_IPS
...
SECRET_KEY = 'django-insecure-ta$xr$g@lhsqf3i^=^vs8&skd)0g1=f^*%k0lnvtlh(33qxe!l'
